...
export default class Posts extends Command {
    constructor() {
        super({
            name: ["posts 1", "posts 2", "posts 3", "posts 4", "posts 5", "posts 6"],
        });
    }
