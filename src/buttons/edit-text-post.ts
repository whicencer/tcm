...
export default class EditCreatedTextGreeting extends Button {
    ...
    async run(ctx, bot) {
        ...
        await ctx.api.editMessageText(ctx.update.callback_query.message.chat.id, ctx.update.callback_query.message.message_id, "❔ Напишите текст поста");
